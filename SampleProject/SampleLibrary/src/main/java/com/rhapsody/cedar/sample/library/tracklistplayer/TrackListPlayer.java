package com.rhapsody.cedar.sample.library.tracklistplayer;
...
import com.rhapsody.cedar.sample.library.tracklistplayer.sequence.NaturalTrackSequencer;
import com.rhapsody.cedar.sample.library.tracklistplayer.sequence.SequenceItem;
import com.rhapsody.cedar.sample.library.tracklistplayer.sequence.ShuffleTrackSequencer;
import com.rhapsody.cedar.sample.library.tracklistplayer.sequence.TrackSequencer;
...
public class TrackListPlayer implements PlayerStateListener{
    ...
    @Override
    public void onError(RhapsodyError rhapsodyError) {
    }
