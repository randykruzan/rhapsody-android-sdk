...
import static com.rhapsody.cedar.sample.library.metadata.Constants.AUTHORIZAION;
...
public interface TrackService {
    ...
    @GET("/v1/me/listens")
    public void getListeningHistory(@Query(APIKEY) String apikey, @Header(AUTHORIZAION) String authorization, Callback<List<Track>> callback);
