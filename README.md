...
We have provided here the SDK ([rhapsody-sdk-1.1.1.jar](https://github.com/Rhapsody/rhapsody-android-sdk/blob/1.1/rhapsody-sdk-1.1.1.jar)) and two sample applications inside the SampleProject which provide examples you can use to build your own app with Rhapsody streaming music.
...
#### SDK Only
The Rhapsody Android SDK is available as a jar. You can download the [rhapsody-sdk-1.1.1.jar](https://github.com/Rhapsody/rhapsody-android-sdk/blob/1.1/rhapsody-sdk-1.1.1.jar) and add it to your Android Studio project gradle.build file:

```groovy
compile files('libs/rhapsody-sdk-1.1.1.jar')
```
